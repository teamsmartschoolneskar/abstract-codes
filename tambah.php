<?php
    //connect to database
    mysqli_connect("localhost", "root", "", "datasiswa");
    ...
    <ul>
        <li>    
            <label for="NRP">NIS :</label>
                <input type="text" name="NIS" id="NRP">
        </li>
        <li>
        ...
        <li>
            <label for="No. Akta Lahir">No. Akkta Lahir :</label>
                <input type="text" name="No. Akta Lahir" id="No. Akta Lahir">
        </li>
        <li>
            <label for="No. Kartu Keluarga">No. Kartu Keluarga :</label>
                <input type="text" name="No. Kartu Keluarga" id="No. Kartu Keluarga">
        </li>
        <li>
            <label for="No. KIP">No. KIP :</label>
                <input type="text" name="No. KIP" id="No. KIP">
        </li>
        <li>
            <label for="No. Seri Ijazah SMP">No. Seri Ijazah SMP :</label>
                <input type="text" name="No. Seri Ijazah SMP" id="No. Seri IJazah SMP">
        </li>
        <li>
            <label for="SMP Asal">SMP Asal :</label>
                <input type="text" name="SMP Asal" id="SMP Asal">
        </li>
        <li>
            <label for="SD Asal">SD Asal :</label>
                <input type="text" name="SD Asal" id="SD Asal">
        </li>
        <li>
            <label for="Kordinat Rumah">Koordinat Rumah :</label>
                <input type="text" name="Koordinat Rumah" id="Koordinat Rumah">
        </li>
    </ul>
    <br><br><br>
    <ul>
